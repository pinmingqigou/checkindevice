package com.freeme.freemelite.attendance.pingan.cameraview.utils;
...
public class CameraUtil {
    ...
    //----------------
    //升序
    public static CameraAscendSizeComparator ascendSizeComparator = new CameraAscendSizeComparator();
    //升序
    ...
    public static Camera.Size getPropPreviewSize(List<Camera.Size> list, int minWidth) {
     ...
     * @return
     */
    public static Camera.Size getPropPictureSize(List<Camera.Size> list, int minWidth) {
        Collections.sort(list, ascendSizeComparator);

        int i = 0;
        for (Camera.Size s : list) {
            Log.e("xxx", "pictureSize: w="+s.width+",h="+s.height );
            if ((s.width >= minWidth)) {
                break;
            }
            i++;
        ...
        Log.e("xxx", "xxx pictureSize: w="+list.get(i).width+",h="+list.get(i).height );
        return list.get(i);
    }
